...
class Event:
    ...
    def get_event_info(self):
        # get 'Event name', 'Event type', 'Event happen time', 'Event place', 'Event machine', 'Event operator', 'Event job', 'Job yield'
        if self.machine != None and self.operator != None:
            event_info=[self.name, self.e_type, self.e_happen_time, self.place.name, self.machine.name, self.operator.name, self.job.name, self.job.processing_yield]
        elif self.machine != None and self.operator == None:
            event_info=[self.name, self.e_type, self.e_happen_time, self.place.name, self.machine.name, self.operator, self.job.name, self.job.processing_yield]
        elif self.machine == None and self.operator != None:
            event_info=[self.name, self.e_type, self.e_happen_time, self.place.name, self.machine, self.operator.name, self.job.name, self.job.processing_yield]
        else:
            event_info=[self.name, self.e_type, self.e_happen_time, self.place.name, self.machine, self.operator, self.job.name, self.job.processing_yield]
